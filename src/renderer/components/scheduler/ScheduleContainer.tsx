...
const ScheduleContainer: React.FC = () => {
    ...
    // const { musicClassStore } = useStores();

    // let schedulerData = musicClassStore.getSchedulerData();

    // useEffect(() => {
    //     schedulerData = musicClassStore.getSchedulerData();
    // }, [musicClassStore.newClassesThisSession]);
