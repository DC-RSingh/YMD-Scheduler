...
import useStyles from './RoomTableFilter.styles';
...
const RoomTableFilter = ({ handleFilter, clearFilter }: TableFilterProps) => {
  const { uiStateStore } = useStores();
  const classes = useStyles();

  const formik = useFormik({
    initialValues: {
      searchText: uiStateStore.roomTableFilterText,
    },
...
export default observer(RoomTableFilter);
