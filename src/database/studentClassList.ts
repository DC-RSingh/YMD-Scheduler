...
const getStudentClassListId = (): void => {
    ipcMain.on('retrieve-studentClassListId', async (e, param) => {
...
const createStudentClassList = (): void => {
    ipcMain.on('create-studentClassList', async (e, staffTypeParams) => {
...
const deleteStudentClassList = (): void => {
    ipcMain.on('delete-studentClassList', async (e, credentialParams) => {
...
const updateStudentClassList = (): void => {
    ipcMain.on('update-studentClassList', async (e, credentialParams) => {
